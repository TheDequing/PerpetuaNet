    ...
    public class WebRTCSyncService : IDisposable
    {
        ...
        public async Task InitializeAndSync()
        {
            ...
            try
            {
                ...
                // Aguarda a criação do canal de dados.
                ...
                // Tenta receber uma oferta remota.
                ...
                if (remoteOffer == null)
                {
                    ...
                    var offer = _pc.createOffer(null);  // Método síncrono
                ...
                else
                {
                    ...
                    var answer = _pc.createAnswer(null);  // Método síncrono
